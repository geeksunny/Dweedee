...
MidiMessage::MidiMessage(uint8_t bytes[], uint8_t length) {
  switch (length) {
    default:length = 3;
    case 3:data_.bytes[2] = bytes[2];
    case 2:data_.bytes[1] = bytes[1];
    case 1:data_.bytes[0] = bytes[0];
      break;
    case 0:break;
  }
  length_ = length;
...
void MidiMessage::refreshLength() {
  if (data_.basicType < 0xF) {
    ...
    switch (data_.basicType) {
      ...
      case dweedee::MidiType::PitchBend:length_ = 3;
        break;
      case dweedee::MidiType::ChannelAfterTouch:
      case dweedee::MidiType::ProgramChange:length_ = 2;
        break;
    ...
    switch (data_.extendedType) {
      case dweedee::MidiType::SongPosition:length_ = 3;
        break;
      case dweedee::MidiType::MTC:
      case dweedee::MidiType::SongSelect:length_ = 2;
        break;
      ...
      case dweedee::MidiType::Reset:length_ = 1;
        break;
      case dweedee::MidiType::Tune:
      case dweedee::MidiType::SysExEnd:
      case dweedee::MidiType::SysEx:break;
      default:length_ = 0;
    }
  }
}
...
void MidiMessage::setType(dweedee::MidiType type) {
  if (data_.basicType < 0xF) {
    ...
    switch (type) {
      ...
      case dweedee::Invalid:data_.basicType = type;
        break;
      default:data_.basicType = Invalid;
    }
  } else {
    // Extended
    switch (type) {
      ...
      case dweedee::Reset:data_.extendedType = type;
        break;
      default:data_.extendedType = Invalid;
    }
  }
  refreshLength();
}
...
void MidiMessage::setType(midi::MidiType type) {
  switch (type) {
    ...
    case midi::PitchBend:data_.extendedType = type + data_.channel;
      break;
      // Extended
    ...
    case midi::SystemReset:data_.extendedType = type;
      break;
    default:data_.basicType = Invalid;
  }
  refreshLength();
